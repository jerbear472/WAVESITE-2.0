-- ============================================================
-- WAVESIGHT CORE FUNCTIONALITY ASSURANCE SCRIPT (SAFE VERSION)
...
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'Column addition warning: %', SQLERRM;
END $$;
...
-- STEP 3: SAFELY HANDLE RLS POLICIES
-- ============================================================
...
BEGIN
    ...
    DROP POLICY IF EXISTS "Anyone can view trends for validation" ON public.trend_submissions;
    ...
    RAISE NOTICE 'Trend submission policies created successfully';
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'Policy creation warning for trend_submissions: %', SQLERRM;
END $$;

DO $$
BEGIN
    -- Drop and recreate policies for trend_validations
    ...
    DROP POLICY IF EXISTS "Authenticated users can add validations" ON public.trend_validations;
    ...
    RAISE NOTICE 'Trend validation policies created successfully';
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'Policy creation warning for trend_validations: %', SQLERRM;
END $$;
...
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'Permission grant warning: %', SQLERRM;
END $$;
...
BEGIN
    ...
    RAISE NOTICE 'RLS policies configured: % policies', v_policies_count;
    RAISE NOTICE '=================================';
    ...
    ELSE
        ...
        RAISE WARNING 'Please check the notices above for details';
    END IF;
END $$;
