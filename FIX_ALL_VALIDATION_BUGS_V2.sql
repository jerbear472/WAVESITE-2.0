-- ============================================
-- FIX ALL VALIDATION AND EARNINGS BUGS V2
...
-- ============================================
-- PART 1: HANDLE VIEW DEPENDENCIES
-- ============================================
...
BEGIN
    ...
    SELECT pg_get_viewdef('verify_page'::regclass, true) INTO v_view_def;
    -- Store it for later
    RAISE NOTICE 'Stored verify_page view definition';
END $$;
...
-- ============================================
-- PART 3: RECREATE THE VIEW
-- ============================================

-- Recreate verify_page view with proper column types
