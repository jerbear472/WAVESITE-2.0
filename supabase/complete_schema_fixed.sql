...
-- Create sample enterprise trends WITHOUT user association (public trends)
INSERT INTO enterprise_trends (title, description, category, velocity, sentiment, geographic_origin, current_phase, validation_score, engagement_count, user_id)
VALUES 
    ('AI-Powered Productivity Tools', 'New wave of AI assistants transforming workplace efficiency', 'technology', 92.5, 0.8, 'San Francisco', 'growing', 87, 125000, NULL),
    ('Sustainable Fashion Movement', 'Gen Z driving eco-conscious fashion choices', 'fashion', 78.3, 0.6, 'London', 'viral', 92, 450000, NULL),
    ('Web3 Gaming Revolution', 'Blockchain-based games seeing massive adoption', 'technology', 85.7, 0.3, 'Seoul', 'emerging', 75, 89000, NULL),
    ('Health Tech Wearables', 'Next-gen health monitoring devices', 'health', 71.2, 0.7, 'Boston', 'growing', 83, 67000, NULL),
    ('Creator Economy Platforms', 'New monetization tools for content creators', 'technology', 88.9, 0.5, 'Los Angeles', 'viral', 90, 234000, NULL)
...
BEGIN 
    ...
    RAISE NOTICE '- profiles (with subscription tiers)';
    RAISE NOTICE '- enterprise_trends';
    RAISE NOTICE '- api_keys';
    RAISE NOTICE '- enterprise_alerts';
    RAISE NOTICE '- alert_notifications';
    RAISE NOTICE '- export_jobs';
    RAISE NOTICE '- integrations';
    RAISE NOTICE '- analytics_cache';
    RAISE NOTICE '';
    RAISE NOTICE 'Sample trends created (5 public trends)';
    RAISE NOTICE '';
    RAISE NOTICE 'Next steps:';
    RAISE NOTICE '1. Create a user account via your app';
    RAISE NOTICE '2. Update their subscription_tier to enterprise/professional';
    RAISE NOTICE '3. Access the enterprise dashboard';
END $$;