...
import { Building2, Users, ChevronDown, Sparkles, TrendingUp, Palette, DollarSign, BarChart3 } from 'lucide-react';
  ...
  if (mobile) {
    return (
      <div className={className}>
        ...
        {/* Show special dashboards for admin users */}
        {user?.is_admin && (
          <>
            ...
            <button
              ...
              className="block w-full text-left px-3 py-2 rounded-md text-base font-medium transition-colors text-gray-700 hover:bg-purple-50 dark:text-gray-300 dark:hover:bg-purple-900/20"
            >
              <Palette className="w-4 h-4 inline mr-2 text-purple-600 dark:text-purple-400" />
              Marketing Dashboard
              <span className="block text-xs text-gray-500 ml-6 mt-1">Cultural insights ($5K/mo)</span>
            </button>
            <button
              onClick={() => router.push('/hedge-fund/dashboard')}
              className="block w-full text-left px-3 py-2 rounded-md text-base font-medium transition-colors text-gray-700 hover:bg-amber-50 dark:text-gray-300 dark:hover:bg-amber-900/20"
            >
              <TrendingUp className="w-4 h-4 inline mr-2 text-amber-600 dark:text-amber-400" />
              Financial Dashboard
              <span className="block text-xs text-gray-500 ml-6 mt-1">Investment signals ($50K/mo)</span>
            </button>
          </>
        )}
      </div>
                ...
                {user?.is_admin && (
                  <>
                    ...
                    <button
                      ...
                      className="group flex w-full items-start px-4 py-3 text-sm transition-colors text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-purple-900/20"
                    >
                      <Palette className="w-5 h-5 mt-0.5 mr-3 flex-shrink-0 text-purple-600 dark:text-purple-400" />
                      <div className="text-left flex-1">
                        <div className="font-medium">Marketing Dashboard</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                          Cultural insights & brand opportunities
                        </div>
                      </div>
                      <div className="ml-auto text-xs text-purple-600 dark:text-purple-400">
                        $5K/mo
                      </div>
                    </button>
                    ...
                    <button
                      onClick={() => {
                        setIsOpen(false);
                        router.push('/hedge-fund/dashboard');
                      }}
                      className="group flex w-full items-start px-4 py-3 text-sm transition-colors text-gray-700 dark:text-gray-300 hover:bg-amber-50 dark:hover:bg-amber-900/20"
                    >
                      <TrendingUp className="w-5 h-5 mt-0.5 mr-3 flex-shrink-0 text-amber-600 dark:text-amber-400" />
                      <div className="text-left flex-1">
                        <div className="font-medium">Financial Dashboard</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                          Investment signals & stock alerts
                        </div>
                      </div>
                      <div className="ml-auto text-xs text-amber-600 dark:text-amber-400">
                        $50K/mo
                      </div>
                    </button>
                  </>
