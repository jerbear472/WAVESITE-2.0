        ...
        <div className="mb-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 border border-blue-200">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Earnings Per Trend</h3>
                <p className="text-sm text-gray-600">Paid after validation (1 approval needed)</p>
              </div>
            </div>
            <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-lg font-bold text-lg">
              {formatCurrency(EARNINGS_CONFIG.BASE_PAYMENT)}
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg p-3 border border-gray-200">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-medium text-gray-700">Finance Bonus</span>
              </div>
              <p className="text-lg font-bold text-yellow-700">+{formatCurrency(EARNINGS_CONFIG.BONUSES.FINANCE)}</p>
              <p className="text-xs text-gray-500">Stocks & crypto trends</p>
            </div>
            
            <div className="bg-white rounded-lg p-3 border border-gray-200">
              <div className="flex items-center gap-2 mb-1">
                <Flame className="w-4 h-4 text-orange-600" />
                <span className="text-sm font-medium text-gray-700">Streak Multiplier</span>
              </div>
              <p className="text-lg font-bold text-orange-700">Up to {EARNINGS_CONFIG.STREAK_MULTIPLIERS.MAX}x</p>
              <p className="text-xs text-gray-500">Session streaks</p>
            </div>
            ...
            <div className="bg-white rounded-lg p-3 border border-gray-200">
              ...
              <p className="text-lg font-bold text-blue-700">1 ✓ to pay</p>
              <p className="text-xs text-gray-500">2 ✗ rejects</p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>• Submit trend → earnings marked as "pending"</li>
                  <li>• 1 validator approves → earnings paid out</li>
                  <li>• 2 validators reject → no payout</li>
                  <li>• Validators earn {formatCurrency(EARNINGS_CONFIG.VALIDATION_REWARDS.CORRECT_VALIDATION)} per validation</li>
                </ul>
              </div>
            </div>
          </div>
