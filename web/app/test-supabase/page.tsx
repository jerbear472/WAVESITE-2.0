  ...
  useEffect(() => {
    async function checkSupabase() {
      try {
        ...
        const url = (client as any).supabaseUrl || (client as any).restUrl || 'Unknown';
        ...
        // Try to query trends
        const { data: trends, error: trendError } = await client
      ...
      <div className="space-y-4">
        {info.error ? (
          <div className="bg-red-900 p-4 rounded">
            ...
            <p className="mt-2 text-sm">This might mean environment variables aren't set in Vercel.</p>
          </div>
        ) : (
          <>
