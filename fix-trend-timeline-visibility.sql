-- Fix Trend Timeline Visibility Issue
...
-- 4. Create simple, permissive policies that should work
...
GRANT USAGE ON SEQUENCE public.trend_submissions_id_seq TO authenticated;
...
-- 7. Test query to see if a specific user can see their trends
