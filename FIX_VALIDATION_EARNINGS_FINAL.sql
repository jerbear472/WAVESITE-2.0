-- FINAL FIX FOR VALIDATION EARNINGS
-- This script ensures validation earnings are exactly $0.02
-- Run this script to fix the $0.10 issue permanently
...
AND routine_name NOT IN ('validate_email', 'validate_username'); -- Exclude unrelated validation functions
